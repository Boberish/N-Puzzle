...
#         # for F in (ChoosingParam):
#         # for F in (ChoosingParam, VisuResult):
#         # frame = F(container, self)
#         frame = ChoosingParam(container, self)
#         self.frames[ChoosingParam] = frame
...
#         puzz = next(lst)
#         print("puzz in VisuResul", puzz)
#         self.next_button = tk.Button(self, width=7, height=2, text="Next Step", command=self.nextStep)
#         self.exit_button = tk.Button(self, width=7, height=2, text="Exit", command=self.quit)
...
#         #         tmp = str(num)
#         #         if (num == 0):
#         #             tk.Label(self, text=' %s ' % tmp, borderwidth=5, relief="sunken", padx=10, pady=10, foreground="maroon", font=LARGE_FONT).pack(side="top")
#         #         else :
#         #             tk.Label(self, text=' %s ' % tmp, borderwidth=5, relief="sunken", padx=10, pady=10, font=LARGE_FONT).pack()
#         #         x += 1
#         #     y +=1
#         #     x = 0
...
#         # VisuResult.tabPuzz(VisuResult, puzz)

#         # print("YAY  retAll !!: ", retPath)
#         self.show_frame(VisuResult)

#     def followingStep(self, puzz):
#         y = 0
#         x = 0
#         for line in puzz:
#             for num in line:
...
# # self.tex1.pack()
# # self.tex1.grid(row=1000, column=1000, padx=30, pady=30)
...
# #             tmp = str(num)
# #             if (num == 0):
# #                 tk.Label(self, text=' %s ' % tmp, borderwidth=5, relief="sunken", padx=10, pady=10, foreground="maroon", font=LARGE_FONT).grid(row=y, column=x, padx=10, pady=10)
# #             else :
# #                 tk.Label(self, text=' %s ' % tmp, borderwidth=5, relief="sunken", padx=10, pady=10, font=LARGE_FONT).grid(row=y, column=x, padx=10, pady=10)
# #             x += 1
# #         y +=1
# #         x = 0
# #     self.exit_button.grid(row=y + 1, column=x + 1)
